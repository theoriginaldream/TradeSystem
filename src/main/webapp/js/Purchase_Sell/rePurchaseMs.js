...
function setImagePreviews(avalue) {
    ...
    dd.innerHTML = "";
    var fileList = document.getElementById("pic_id").files;
    ...
    for (var i = 0; i < fileList.length; i++) {
        dd.innerHTML += "<div style='float:left' > <img id='img" + i + "'  />"+"<div class='list'  >" +"<button id='delete' class='delete'style='font-size:15px; margin-left:1rem' >删除</button></div>"+" </div>";
...
subtn.onclick = function() {
    ...
    formData.append("ritemname",document.getElementById("P_detail").value)
    formData.append("schoolzone",document.getElementById("P_area").value)
    // formData.append("type",document.getElementById("way").value)
    // formData.append("price",document.getElementById("price").value)
    
    var pics = document.getElementById("pic_id")
    ...
    $.ajax({
        ...
        async: false,
        // data:JSON.stringify({
        //     "P_detail":document.getElementById("P_detail").innerHTML,
        //     "P_area":document.getElementById("P_area").innerHTML,
